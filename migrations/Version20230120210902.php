 ...
 */
final class Version20230120210902 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE service_schedule (id SERIAL NOT NULL, service_id VARCHAR(255) NOT NULL, reservation_id VARCHAR(255) DEFAULT NULL, day_available VARCHAR(255) NOT NULL, available_from VARCHAR(255) NOT NULL, available_to VARCHAR(255) NOT NULL, available_time VARCHAR(255) NOT NULL, is_available BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C84955A40BC2D5 FOREIGN KEY (schedule_id) REFERENCES service_schedule (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
