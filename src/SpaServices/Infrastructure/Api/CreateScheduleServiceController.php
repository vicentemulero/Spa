...
final class CreateScheduleServiceController extends ApiController
{
    ...
    private function validateRequest(Request $request): ?array
    {
        $constraint = new Assert\Collection(
            [
                'day_available' => [new Assert\NotBlank(), new Assert\Type(["string"]), new Assert\Regex(['pattern' => '#^(0[1-9]|[12][0-9]|3[01])/(0[1-9]|1[0-2])/([0-9]{4})$#']),
                ...
                'available_from' => [new Assert\NotBlank(), new Assert\Type(["string"]),
                ...
                'available_to' => [new Assert\NotBlank(), new Assert\Type(["string"]), new Assert\Regex(['pattern' => '#^(0[0-9]|1[0-9]|2[0-3]):00$#']),
    ...
    protected function exceptions(): array
    {
        return [
            ...
            ServiceScheduleAlreadyDefined::class=>Response::HTTP_CONFLICT
        ];
    }
}
